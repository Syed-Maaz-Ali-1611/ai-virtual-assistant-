...
root.title("VOICE RECOGNITION FOR LOCK SYSTEM")

frame = customtkinter.CTkFrame(master= root)
frame.pack(pady = 20, padx = 60 , fill = "both", expand = True)

label = customtkinter.CTkLabel(master= frame , text= "SELECT LANGUAGE", font= ("Comic Sans MS", 20, "bold"))
...
optionmenu1st_level = customtkinter.CTkOptionMenu(master=frame, values=["", "English", "Urdu"], command=callback)
optionmenu1st_level.pack(pady = 12 , padx = 10)
optionmenu1st_level.set("Language")
